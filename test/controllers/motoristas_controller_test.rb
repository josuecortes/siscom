...
class MotoristasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motorista" do
    assert_difference('Motorista.count') do
      post motoristas_url, params: { motorista: { celular: @motorista.celular, cnh: @motorista.cnh, cpf: @motorista.cpf, data_nascimento: @motorista.data_nascimento, nome: @motorista.nome, validade_cnh: @motorista.validade_cnh } }
    end
  ...
  test "should update motorista" do
    patch motorista_url(@motorista), params: { motorista: { celular: @motorista.celular, cnh: @motorista.cnh, cpf: @motorista.cpf, data_nascimento: @motorista.data_nascimento, nome: @motorista.nome, validade_cnh: @motorista.validade_cnh } }
