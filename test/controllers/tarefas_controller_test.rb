...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { descricao: @tarefa.descricao, etapa_id: @tarefa.etapa_id, fim: @tarefa.fim, inicio: @tarefa.inicio, status: @tarefa.status, tipo: @tarefa.tipo, titulo: @tarefa.titulo, user_id: @tarefa.user_id } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { descricao: @tarefa.descricao, etapa_id: @tarefa.etapa_id, fim: @tarefa.fim, inicio: @tarefa.inicio, status: @tarefa.status, tipo: @tarefa.tipo, titulo: @tarefa.titulo, user_id: @tarefa.user_id } }
